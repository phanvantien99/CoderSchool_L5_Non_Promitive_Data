...
class Program
{
    static void Main(string[] args)
    {
        ...
        Potion potion = new Potion("Health potion", 15);
        potion.Use(player);
        //---------------------------------------------------------------------
        ...
        List<Items> reward = new List<Items>();
        reward.Add(new Potion("Large health", 50));
        reward.Add(new Potion("Small health", 20));
        reward.Add(new Potion("Medium health", 35));
        Quest quest = new Quest("Introducing", "Introducing yourself to Naomi", reward, 0);
        player.PerformQuest(quest, 25);
        player.PerformQuest(quest, 75);
        ...
        player.Inventory.searchItemsByName();
        player.Inventory.removeItems(2, 1);
        ...
        Spell spell = new Spell("Ice age", 45, 45);
        player.LearnSpell(spell);
        player.PerformCastSpell(player.Spells[0], enemy);
        player.PerformCastSpell(player.Spells[0], enemy);
        player.PerformCastSpell(player.Spells[0], enemy);
    }
}
